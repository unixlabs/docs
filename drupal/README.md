...
-	[`9.2.7-php8.0-apache-buster`, `9.2-php8.0-apache-buster`, `9-php8.0-apache-buster`, `php8.0-apache-buster`, `9.2.7-php8.0-apache`, `9.2-php8.0-apache`, `9-php8.0-apache`, `php8.0-apache`, `9.2.7-apache-buster`, `9.2-apache-buster`, `9-apache-buster`, `apache-buster`, `9.2.7-apache`, `9.2-apache`, `9-apache`, `apache`, `9.2.7`, `9.2`, `9`, `latest`, `9.2.7-php8.0`, `9.2-php8.0`, `9-php8.0`, `php8.0`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php8.0/apache-buster/Dockerfile)
-	[`9.2.7-php8.0-fpm-buster`, `9.2-php8.0-fpm-buster`, `9-php8.0-fpm-buster`, `php8.0-fpm-buster`, `9.2.7-php8.0-fpm`, `9.2-php8.0-fpm`, `9-php8.0-fpm`, `php8.0-fpm`, `9.2.7-fpm-buster`, `9.2-fpm-buster`, `9-fpm-buster`, `fpm-buster`, `9.2.7-fpm`, `9.2-fpm`, `9-fpm`, `fpm`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php8.0/fpm-buster/Dockerfile)
-	[`9.2.7-php8.0-fpm-alpine3.14`, `9.2-php8.0-fpm-alpine3.14`, `9-php8.0-fpm-alpine3.14`, `php8.0-fpm-alpine3.14`, `9.2.7-php8.0-fpm-alpine`, `9.2-php8.0-fpm-alpine`, `9-php8.0-fpm-alpine`, `php8.0-fpm-alpine`, `9.2.7-fpm-alpine3.14`, `9.2-fpm-alpine3.14`, `9-fpm-alpine3.14`, `fpm-alpine3.14`, `9.2.7-fpm-alpine`, `9.2-fpm-alpine`, `9-fpm-alpine`, `fpm-alpine`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php8.0/fpm-alpine3.14/Dockerfile)
-	[`9.2.7-php8.0-fpm-alpine3.13`, `9.2-php8.0-fpm-alpine3.13`, `9-php8.0-fpm-alpine3.13`, `php8.0-fpm-alpine3.13`, `9.2.7-fpm-alpine3.13`, `9.2-fpm-alpine3.13`, `9-fpm-alpine3.13`, `fpm-alpine3.13`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php8.0/fpm-alpine3.13/Dockerfile)
-	[`9.2.7-php7.4-apache-buster`, `9.2-php7.4-apache-buster`, `9-php7.4-apache-buster`, `php7.4-apache-buster`, `9.2.7-php7.4-apache`, `9.2-php7.4-apache`, `9-php7.4-apache`, `php7.4-apache`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php7.4/apache-buster/Dockerfile)
-	[`9.2.7-php7.4-fpm-buster`, `9.2-php7.4-fpm-buster`, `9-php7.4-fpm-buster`, `php7.4-fpm-buster`, `9.2.7-php7.4-fpm`, `9.2-php7.4-fpm`, `9-php7.4-fpm`, `php7.4-fpm`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php7.4/fpm-buster/Dockerfile)
-	[`9.2.7-php7.4-fpm-alpine3.14`, `9.2-php7.4-fpm-alpine3.14`, `9-php7.4-fpm-alpine3.14`, `php7.4-fpm-alpine3.14`, `9.2.7-php7.4-fpm-alpine`, `9.2-php7.4-fpm-alpine`, `9-php7.4-fpm-alpine`, `php7.4-fpm-alpine`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php7.4/fpm-alpine3.14/Dockerfile)
-	[`9.2.7-php7.4-fpm-alpine3.13`, `9.2-php7.4-fpm-alpine3.13`, `9-php7.4-fpm-alpine3.13`, `php7.4-fpm-alpine3.13`](https://github.com/docker-library/drupal/blob/c0994af8e20764108bbe8d4e597bee7b5d8e944d/9.2/php7.4/fpm-alpine3.13/Dockerfile)
-	[`9.1.13-php8.0-apache-buster`, `9.1-php8.0-apache-buster`, `9.1.13-php8.0-apache`, `9.1-php8.0-apache`, `9.1.13-apache-buster`, `9.1-apache-buster`, `9.1.13-apache`, `9.1-apache`, `9.1.13`, `9.1`, `9.1.13-php8.0`, `9.1-php8.0`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php8.0/apache-buster/Dockerfile)
-	[`9.1.13-php8.0-fpm-buster`, `9.1-php8.0-fpm-buster`, `9.1.13-php8.0-fpm`, `9.1-php8.0-fpm`, `9.1.13-fpm-buster`, `9.1-fpm-buster`, `9.1.13-fpm`, `9.1-fpm`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php8.0/fpm-buster/Dockerfile)
-	[`9.1.13-php8.0-fpm-alpine3.13`, `9.1-php8.0-fpm-alpine3.13`, `9.1.13-php8.0-fpm-alpine`, `9.1-php8.0-fpm-alpine`, `9.1.13-fpm-alpine3.13`, `9.1-fpm-alpine3.13`, `9.1.13-fpm-alpine`, `9.1-fpm-alpine`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php8.0/fpm-alpine3.13/Dockerfile)
-	[`9.1.13-php7.4-apache-buster`, `9.1-php7.4-apache-buster`, `9.1.13-php7.4-apache`, `9.1-php7.4-apache`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php7.4/apache-buster/Dockerfile)
-	[`9.1.13-php7.4-fpm-buster`, `9.1-php7.4-fpm-buster`, `9.1.13-php7.4-fpm`, `9.1-php7.4-fpm`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php7.4/fpm-buster/Dockerfile)
-	[`9.1.13-php7.4-fpm-alpine3.13`, `9.1-php7.4-fpm-alpine3.13`, `9.1.13-php7.4-fpm-alpine`, `9.1-php7.4-fpm-alpine`](https://github.com/docker-library/drupal/blob/667c2c7d5ca82202b96eff2f52b69a387ebd954d/9.1/php7.4/fpm-alpine3.13/Dockerfile)
-	[`8.9.19-php7.4-apache-buster`, `8.9-php7.4-apache-buster`, `8-php7.4-apache-buster`, `8.9.19-php7.4-apache`, `8.9-php7.4-apache`, `8-php7.4-apache`, `8.9.19-apache-buster`, `8.9-apache-buster`, `8-apache-buster`, `8.9.19-apache`, `8.9-apache`, `8-apache`, `8.9.19`, `8.9`, `8`, `8.9.19-php7.4`, `8.9-php7.4`, `8-php7.4`](https://github.com/docker-library/drupal/blob/5dfa44912190e26d694dc136694e85f45f2f4300/8.9/php7.4/apache-buster/Dockerfile)
-	[`8.9.19-php7.4-fpm-buster`, `8.9-php7.4-fpm-buster`, `8-php7.4-fpm-buster`, `8.9.19-php7.4-fpm`, `8.9-php7.4-fpm`, `8-php7.4-fpm`, `8.9.19-fpm-buster`, `8.9-fpm-buster`, `8-fpm-buster`, `8.9.19-fpm`, `8.9-fpm`, `8-fpm`](https://github.com/docker-library/drupal/blob/5dfa44912190e26d694dc136694e85f45f2f4300/8.9/php7.4/fpm-buster/Dockerfile)
-	[`8.9.19-php7.4-fpm-alpine3.13`, `8.9-php7.4-fpm-alpine3.13`, `8-php7.4-fpm-alpine3.13`, `8.9.19-php7.4-fpm-alpine`, `8.9-php7.4-fpm-alpine`, `8-php7.4-fpm-alpine`, `8.9.19-fpm-alpine3.13`, `8.9-fpm-alpine3.13`, `8-fpm-alpine3.13`, `8.9.19-fpm-alpine`, `8.9-fpm-alpine`, `8-fpm-alpine`](https://github.com/docker-library/drupal/blob/5dfa44912190e26d694dc136694e85f45f2f4300/8.9/php7.4/fpm-alpine3.13/Dockerfile)
